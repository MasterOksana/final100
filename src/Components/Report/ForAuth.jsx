...
export const ForAuth = ({
  ...
  const [licenseNumber, setLicenseNumber] = useState("licenseNumber string");
  const [ownerFullName, setOwnerFullName] = useState("typestring");
  const [color, setColor] = useState("color string");
  const [date, setDate] = useState("date date");
  const [description, setDescription] = useState("");
  const [type, setType] = useState("description string");
  const [message, setMessage] = useState("message string");
  const [officer, setOfficer] = useState("officer string");
